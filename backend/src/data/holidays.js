 ...
 * frontend/src/utils/holidayCalendar.js. They intentionally live as two
 * separate copies (CommonJS backend vs ES module frontend, different build
 ...
 */
function isTradingHoliday(date, exchange = "NSE") {
 ...
 */
function previousTradingDay(date, exchange = "NSE") {
